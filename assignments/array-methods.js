...
let allCaps = runners.map(runners => runners.first_name.toUpperCase()); //let new array allCaps be assigned runners mapped to return the runners.firstName uppercased
console.log(allCaps); 
